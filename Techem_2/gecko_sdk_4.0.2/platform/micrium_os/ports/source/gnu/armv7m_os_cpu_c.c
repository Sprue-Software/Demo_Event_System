...
// Instructions to disable IRQs.
__asm__(".global OSDisableIRQ1");
__asm__(".global OSDisableIRQ2");
__asm__(".global OSDisableIRQ3");

// Instructions to enable IRQs.
__asm__(".global OSEnableIRQ1");
__asm__(".global OSEnableIRQ2");
__asm__(".global OSEnableIRQ3");

// BASEPRI priorities
__asm__(".equ BASE_PRI_LVL, " XSTR(CORE_ATOMIC_BASE_PRIORITY_LEVEL));
__asm__(".equ BASE_PRI_SHF, " XSTR(__NVIC_PRIO_BITS               ));
__asm__(".equ BASE_PRI_VAL,   BASE_PRI_LVL<<(8-BASE_PRI_SHF)      ");
__asm__(".equ ZERO_PRI_VAL,   0x00                                ");

// Assembler instructions.
__asm__(".equ SET_R00_OP,     0x2000 | BASE_PRI_VAL");
__asm__(".equ CLR_R00_OP,     0x2000 | ZERO_PRI_VAL");
__asm__(".equ MSR_R00_OP,     0xF380               ");
__asm__(".equ BASEPRI_OP,     0x8811               ");
__asm__(".equ CPSID_I_OP,     0xB672               ");
__asm__(".equ CPSIE_I_OP,     0xB662               ");
__asm__(".equ NO_OPER_OP,     0xBF00               ");

#if (CORE_ATOMIC_METHOD == CORE_ATOMIC_METHOD_BASEPRI)
// Disable interrupts by setting BASEPRI to 0x60.
__asm__(".set OSDisableIRQ1,  SET_R00_OP");  // 2060    MOVS    R0, #0x60
__asm__(".set OSDisableIRQ2,  MSR_R00_OP");  // F380    MSR     BASEPRI, R0
__asm__(".set OSDisableIRQ3,  BASEPRI_OP");  // 8811            ...

// Enable interrupts by setting BASEPRI to 0x00.
...
#else
// Disable interrupts by masking them all.
__asm__(".set OSDisableIRQ1,  CPSID_I_OP");  // B672    CPSID   I
__asm__(".set OSDisableIRQ2,  NO_OPER_OP");  // BF00    NOP
__asm__(".set OSDisableIRQ3,  NO_OPER_OP");  // BF00    NOP

// Enable interrupts by unmasking them all.
__asm__(".set OSEnableIRQ1,   CPSIE_I_OP");  // B662    CPSIE   I
__asm__(".set OSEnableIRQ2,   NO_OPER_OP");  // BF00    NOP
__asm__(".set OSEnableIRQ3,   NO_OPER_OP");  // BF00    NOP
#endif
