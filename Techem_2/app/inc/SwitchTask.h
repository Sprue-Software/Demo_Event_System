/**
 * @file	SwitchTask.h
 * @brief	Handle the switch interrupts, polling and status.
 * @project SA2888 Gen5 Core Firmware
 * @date	29 Oct 2019
 * @author  CBaker
 */

#ifndef INC_SWITCHTASK_H_
#define INC_SWITCHTASK_H_

#ifdef DEBUG_ENABLE_SWITCHES
#define DEBUG_SWITCHES(str, numMode, dataValue) sendDebugMsg(str,numMode,dataValue)
#else
